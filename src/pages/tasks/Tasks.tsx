      ...
      <div className="box box1">
        ...
        <div className="task">
          ...
          <div>
            ...
            <button onClick={() => updateDisplay("Business Development")}>
              Proceed
            </button>
          </div>
        </div>
        <div className="task">
          ...
          <div>
            <p>Marketing</p>
            <button onClick={() => updateDisplay("Marketing")} className="btn">
              Proceed
            </button>
          </div>
        </div>
        <div className="task">
          ...
          <div>
            ...
            <button onClick={() => updateDisplay("Operation and Engineering")}>
              Proceed
            </button>
          </div>
        </div>
        <div className="task">
          ...
          <div>
            ...
            <button onClick={() => updateDisplay("International Business")}>
              Proceed
            </button>
          </div>
        </div>
        <div className="task">
          ...
          <div>
            <p>Weekly Report</p>
            <button onClick={() => updateDisplay("Weekly Report")}>
              Proceed
            </button>
          </div>
        </div>
